...
Rào cản cũng phải nhìn cho rõ. Các hướng như kernel cơ sở dữ liệu, trình biên dịch, lưu trữ, middleware phân tán, quả thực có thể rèn luyện năng lực tầng dưới rất mạnh, nhưng chu kỳ học tập cũng dài. Hướng gần nghiệp vụ hơn dễ tìm được cửa vào hơn; muốn tạo ra khác biệt, hiểu biết nghiệp vụ, chất lượng kỹ thuật và năng lực xử lý sự cố trực tuyến càng hữu dụng hơn.
...
- Một interface từ lúc request vào đến khi trả kết quả, đi qua những tầng nào?
...
- Khi interface trực tuyến chậm lại, làm thế nào từng bước tra từ log, chuỗi gọi, SQL, thread pool?

Nếu bạn chưa vào nghề, backend vẫn là cửa vào rất thực tế. Trước tiên đánh chắc Java cơ bản, cơ sở dữ liệu, Spring, Redis, message queue, thực hành dự án, rồi mới cân nhắc mở rộng sang phát triển ứng dụng AI, middleware, platform engineering hay hướng kiến trúc, sẽ vững hơn nhiều. Đừng vội dán nhãn "kiến trúc" hay "AI" cho mình ngay từ đầu, nền móng chưa vững, sau này đổi hướng nào cũng tốn sức.
...
Đối với đa số developer, chỗ full-stack phát huy tác dụng nhất, là có thể độc lập bàn giao một chức năng hoàn chỉnh: hiểu yêu cầu, cấu trúc trang, thiết kế interface, mô hình hóa dữ liệu, kiểm soát quyền hạn, liên kết test, triển khai lên môi trường, xử lý sự cố — đều nối được lại. Với các bạn backend, full-stack không nhất thiết yêu cầu bạn trong thời gian ngắn đạt đến độ sâu của một frontend chuyên nghiệp, nhưng ít nhất phải xem hiểu trang, sửa được component, nói rõ được luồng dữ liệu.
...
AI có thể giúp bạn sinh trang, interface, SQL, script triển khai, nhưng cuối cùng vẫn là bạn chịu trách nhiệm với kết quả. Trường dữ liệu có khớp không, quyền hạn có sót không, bất thường có được bọc đáy không, sau khi triển khai tra sự cố thế nào, những cái này đều không thể giao cho công cụ đoán.
...
Trong nước, đội ngũ làm kernel cơ sở dữ liệu lâu dài không nhiều bằng phát triển nghiệp vụ, vị trí tự nhiên cũng ít. Người phù hợp đi theo hướng này, thường chấp nhận được việc đọc paper, đọc mã nguồn, tinh chỉnh hiệu năng, xử lý những vấn đề rất khó tái hiện, cũng chấp nhận được việc một chức năng sửa rất lâu mới lên môi trường.
...
Công việc của nhiều vị trí thuật toán sẽ rơi vào những việc này: hiểu mục tiêu nghiệp vụ, lấy được dữ liệu dùng được, xử lý feature và sample, huấn luyện và đánh giá mô hình, nối mô hình vào dịch vụ trực tuyến, quan sát chỉ số, xử lý hiệu quả suy giảm.
...
Thi đấu có thể rèn luyện năng lực trừu tượng, cấu trúc dữ liệu và ý thức độ phức tạp, có trợ giúp với một phần vị trí yêu cầu thuật toán cao. Tuy nhiên, đa số software engineer không cần coi thi thuật toán là điều kiện cần thiết cho phát triển nghề nghiệp. Công việc thuật toán trong nghiệp vụ thực tế, hiếm khi chỉ kiểm tra xem có giải được một bài toán hay không, mà nhiều hơn là hỏi: bạn có thể tách một vấn đề không ổn định thành những thí nghiệm có thể kiểm chứng, cuối cùng để nó tạo ra lợi ích ổn định trên môi trường thật không.

Nếu bạn muốn đi theo hướng thuật toán, nên xác nhận sớm xem mình có chấp nhận được hai việc:

- Có sẵn lòng bổ sung năng lực kỹ thuật không, ví dụ Python/Java/C++, data pipeline, mô hình phục vụ, đánh giá trực tuyến, giám sát cảnh báo.
...
Middleware có thể hiểu trước là "một tầng phần mềm lót đáy cho hệ thống nghiệp vụ". Middleware phổ biến bao gồm message queue, framework RPC, trung tâm cấu hình, trung tâm đăng ký, lập lịch tác vụ, gateway, component chia bảng chia khóa (sharding), công cụ đồng bộ dữ liệu, cache proxy…
...
Muốn làm phát triển middleware, có thể bắt đầu đào sâu từ một middleware. Ví dụ học message queue, đừng chỉ dừng lại ở những đáp án kiểu "cắt đỉnh dựa biển, giải ghép không đồng bộ", tiếp tục đào sâu xuống: message lưu thế nào, consumer offset duy trì thế nào, tiêu thụ trùng lặp xử lý thế nào, message có thứ tự phải trả cái giá gì, sau khi Broker chết khôi phục thế nào.
...
- Những tình huống như interface idempotent, async message, distributed transaction làm sao test?
- Sau khi sự cố trực tuyến lộ ra, quy trình chất lượng sửa thế nào?

Nếu sau này bạn còn muốn chuyển sang phát triển, cũng phải thiết kế dự án từ trước. Cố gắng để dự án test development của bạn có nội dung phát triển thực sự, ví dụ nền tảng test, công cụ tạo dữ liệu, nền tảng ép tải, công cụ ghi - phát lại interface, thay vì chỉ viết "phụ trách thực thi test tự động hóa". Loại mô tả này để lên CV, người phỏng vấn rất khó phán đoán năng lực phát triển của bạn.
...
Nếu bạn đã có một hai năm kinh nghiệm, có thể xem trong công việc mình sẵn lòng chủ động làm thêm điều gì nhất. Có người thích theo một câu SQL chậm tra đến index và execution plan; có người thích biến quy trình phát hành lặp lại thành công cụ; có người thích phục bàn sự cố trực tuyến về đến giám sát và ép tải; có người thích trừu tượng hóa vấn đề nghiệp vụ thành mô hình và chỉ số. Thứ bạn sẵn lòng nghiền ngẫm đi nghiền ngẫm lại, thường nói rõ hướng đi rõ hơn tên vị trí.
...
- Viết một nền tảng test tự động hóa interface đơn giản.
